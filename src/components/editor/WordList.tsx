  ...
  return (
    <div className={`flex items-center gap-1 shrink-0 ${isDragging ? "opacity-30" : ""} ${isPlaced || dragDisabled ? "opacity-40" : ""}`}>
      ...
      >
        ...
        <span className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 rounded-full bg-gray-200 ring-1 ring-white shadow-[inset_0_1px_2px_rgba(0,0,0,0.4)] pointer-events-none" />
